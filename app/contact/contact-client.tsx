...
import { Mail, Send, MessageSquareIcon as MessageSquareQuestion, AlertCircle } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { useState } from "react"
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion"
// Update the imports to use our new email service
import { sendContactEmail } from "@/lib/email-service"
import { useActionState } from "react"
import { useEffect } from "react"
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import type { ContactFormState } from "@/lib/email-service" // Import the state type
...
const initialState: ContactFormState = {
  success: false,
  message: "",
  errors: [], // errors is optional in ContactFormState, so an empty array is fine
}
...
export default function ContactClientPage() {
  ...
  // Add useEffect to show toast when form is submitted
  useEffect(() => {
